...
describe('As part of the sql refresh workshop', () => {
  ...
  it('you should be able to add 2 Male & 3 Female garments', async () => {
    ...
    db.none(garment_add_sql, ['Golf t-shirt','collared-128x128-455119.png','Summer','Male','147.43']);
    db.none(garment_add_sql, ['Blue Jersey','sweater-128x128-455131.png','Winter','Male','499.99']);
    db.none(garment_add_sql, ['Purple Dress','tunic-128x128-455137.png','Summer','Female','399.99']);
    db.none(garment_add_sql, ['Short Skirt(Yellow)','skirt-128x128-455130.png','Summer','Female','199.99']);
    db.none(garment_add_sql, ['Short Skirt(Pink)','skirt-128x128-455130.png','Summer','Female','199.99']);
